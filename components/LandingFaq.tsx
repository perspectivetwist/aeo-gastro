...
const faqItems = [
  {
    ...
    answer: 'In 20 Sekunden analysiert unsere KI deine Website nach den gleichen Kriterien, nach denen ChatGPT, Perplexity & Co. Antworten auswählen. Du bekommst sofort einsatzbereiten, optimierten Content – kein Account, keine Agentur, kein Warten. Einfach URL eingeben, fertig.',
    alwaysOpen: true,
  },
  {
    question: 'Warum gibt es den AEO Scanner und warum jetzt?',
    answer: 'Weil 90% aller Websites von KI-Suchmaschinen nicht verstanden werden — und die meisten Inhaber es nicht wissen.\n\nChatGPT, Perplexity & Co. beantworten Fragen direkt. Wer nicht zitiert wird, existiert nicht. Die Zahlen:\n\n• 58% der Konsumenten nutzen KI-Tools statt Google für Produkt- und Servicesuche (Capgemini 2025)\n• +527% Anstieg KI-generierter Website-Referrals in nur 5 Monaten (Previsible Jan–Mai 2025)\n• 25% aller Suchanfragen wandern bis 2028 zu KI-Engines (Gartner)\n• 800 Mio. wöchentliche ChatGPT-Nutzer — Stand Ende 2025 (OpenAI)\n• AI Search Traffic konvertiert mit 14,2% — fünfmal besser als Google mit 2,8%\n\nDer AEO Scanner macht in 20 Sekunden sichtbar ob deine Website KI-lesbar ist — und liefert sofort optimierten Content zum Einbauen.',
  },
  {
    question: 'Was ist AEO und warum brauche ich das?',
    answer: 'AEO (Answer Engine Optimization) optimiert deine Website für KI-Suchmaschinen. Während Google Links rankt, wählen ChatGPT und Perplexity direkte Antworten aus. Mit AEO sicherst du dir Sichtbarkeit in KI-Antworten – ohne traditionelles Ranking.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Der Score (0–100) misst, wie gut deine Website für KI-Zitierung optimiert ist. Er berücksichtigt Content-Struktur, Klarheit der Antworten und technisches Markup – direkt vergleichbar mit dem Standard von ChatGPT & Co.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Alle Websites profitieren: Blogs, E-Commerce, SaaS, Agenturen und Unternehmen. Besonders wichtig für Seiten, die Fragen beantworten – denn diese werden von KI-Suchmaschinen zitiert.',
  },
  {
